...
class FormNivelPerdido(Form):
    def __init__(self, screen, x, y, w, h, active, path_image):
        ...
        self._btn_reintentar = Button_Image(screen=self._slave,
                                        ...
                                        onclick_param = "",
                                        path_image = "Recursos/GUI/Boton_reintentar.png")
        ...
        self.label_titulo = Label(self._slave, 130, 0, 420, 100, "GAME OVER", "Recursos/Fuentes/Fuente.ttf", 30, "Black", "Recursos\GUI\Interfaz1.png")
